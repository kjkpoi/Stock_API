#if !defined(AFX_XF5_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_)
#define AFX_XF5_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_


#include "../include/Data_Common.h"

/****** CME선물주문체결 Real (XF5) *********************************/
/****** SVR : CME선물주문체결 Real(HTS)  ***************************/
/********************************************************************/
...
public:
	...
	virtual void  Convert(DRDS_XF5_DATA* pInput)
	{
		CString sTemp1 ;
		char sTmp[40+1];
...
#endif // AFX_XF5_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_
