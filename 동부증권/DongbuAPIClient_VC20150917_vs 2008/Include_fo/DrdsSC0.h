#if !defined(AFX_SC0_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_)
#define AFX_SC0_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_

// #include "../CommonTR/Drds_SC0.h"
...
typedef struct {
        ...
        DEFINE_DRDS_LINE0("kospi200",                       kospi200,     char,   7)
...
public:
	...
	virtual void  Convert(DRDS_SC0_DATA* pInput)
	{
		CString sTemp1 ;
		char sTmp[20+1];
...
typedef struct
{
	...
	//char       nearprice    [5];		  // 근월물약정가격[9(3)v99]
	//char       farprice     [5];		  // 원월물약정가격[9(3)v99]
	...
	//char       nearvolume   [7];		// 근월물체결수량     
	//char       nearvalue    [11];		// 근월물거래대금
	//char       farvolume    [7];		// 원월물체결수량
	//char       farvalue     [11];		// 원월물거래대금
...
#define st_SC0_Size		sizeof(st_SC0) 


#endif // AFX_SC0_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_