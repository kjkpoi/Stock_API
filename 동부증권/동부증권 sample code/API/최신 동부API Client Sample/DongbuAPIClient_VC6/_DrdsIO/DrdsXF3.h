#if !defined(AFX_XF3_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_)
#define AFX_XF3_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_

// #include "../CommonTR/DrdsXF3.h"
// 작성 : 이윤희
// 날자 : 2005.12.22(목)
...
typedef struct {
	...
	DEFINE_DRDS_LINE0( "현재가",                         close,        char,   6)  // 6=> 15
	DEFINE_DRDS_LINE0( "매수호가",                       bid,          char,   6)  // 6=> 15
	DEFINE_DRDS_LINE0( "매도호가",                       offer,        char,   6)  // 6=> 15
	DEFINE_DRDS_LINE0( "상한가",                         hilimit,      char,   6)  // 6=> 15
	DEFINE_DRDS_LINE0( "하한가",                         lolimit,      char,   6)  // 6=> 15
	...
	DEFINE_DRDS_LINE0( "거래단위",                       unit,         char,   8)  // 8->19
...
public:
	...
	virtual void  Convert(DRDS_XF3_DATA* pInput)
	{
		CString sTemp1 ;
		char sTmp[30+1];
...
#endif // AFX_XF3_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_
