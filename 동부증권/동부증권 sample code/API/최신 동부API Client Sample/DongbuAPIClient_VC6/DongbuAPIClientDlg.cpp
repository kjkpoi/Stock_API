...
BEGIN_MESSAGE_MAP(CDongbuAPIClientDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BTN_JANGO2,	OnBtnJango2)		
...
{	
	...
	GetDlgItem(IDC_BTN_JANGO2)->EnableWindow(bEnable) ;
...
// FUNCTION : 잔고조회(원장)
//=======================================================================================
void CDongbuAPIClientDlg::OnBtnJango2() 
{	
	CExInqueryDlg dlgQuery ;	
	dlgQuery.m_nTRCode = atoi(TR_15812);
	dlgQuery.DoModal() ;	
}
