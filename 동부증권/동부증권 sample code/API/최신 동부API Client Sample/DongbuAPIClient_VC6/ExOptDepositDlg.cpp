...
void CExOptDepositDlg::ParseSubMessage(char *pTRData, int &nOffset, int &nCount) 
{
	...
	switch (nDataType)
	{
		...
		default :						
			...
			{	
				...
				{
					CString szData ;
					int nSZData = sizeof(TR_16260_G) ;
					TR_16260_G* pData = (TR_16260_G*)(prData->TRData+nOffset);
