#if !defined(AFX_OH0_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_)
#define AFX_OH0_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_

// #include "../CommonTR/Drds_OH0.h"
...
typedef struct {
	DEFINE_DRDS_LINE0("종목코드",                       jmcode,       char,   8)
    DEFINE_DRDS_LINE0("종목코드SEQ",                    jmcodeseq,    char,   3)
...
#define st_OH0_Size		sizeof(st_OH0)

#endif // AFX_OH0_DRDSPACKET_BY_JUNOK_LEE_98B1A__INCLUDED_
